...
app.config(['NgAdminConfigurationProvider', function (NgAdminConfigurationProvider) {
    ...
    patient
        .addRelatedEntity(medication)
        .addRelatedEntity(appointment)
        .addRelatedEntity(encounter)
        .addRelatedEntity(allergy);

    medication.listView().fields([
        nga.field('id').label('id')
    ]).listActions(['show', 'edit', 'delete']);
    medication.creationView()
        .fields([nga.field('id').label('id'), nga.field('status').label('status')]);
    medication.showView().fields([
    ...
    patient.showView().menu(nga.menu()
        .addChild(nga.menu(medication).relativeRoute(true).title('Medication'))
    );
